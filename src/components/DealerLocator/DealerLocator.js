...
componentDidMount(){
    Axios.get('http://localhost:3001/dealerships').then(res => {
...
render(){
    if(this.state.dealerships){
        ...
        let searchBar = <div>
            ...
            <Row>
                {/* puts search bar in center of page */}
                    ...
                    <Form>
                        <FormGroup>
                            <InputGroup>
                                ...
                                name = "user_address"
                                placeholder = "Were probably nearby. What state are you in?" />
