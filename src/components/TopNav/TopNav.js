			...
			<Navbar color="light" light expand="md">
			  ...
			  <Collapse isOpen={this.state.isOpen} navbar>
				<Nav className="ml-auto" navbar>
				  ...
				  <NavItem>
					  <NavLink href='/find-a-dealer'><i className="fas fa-map-marked-alt"></i> Find A Dealer</NavLink>
				  </NavItem>
				  <NavItem>
					  <NavLink href='/build-and-price'><i className="fas fa-users-cog"></i>Build And Price</NavLink>
				  </NavItem>
				</Nav>
			  </Collapse>
			</Navbar>
